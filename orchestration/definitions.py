...
from orchestration.assets.ingest import raw_bundesbank, raw_ecb, raw_ecbwatch, raw_fred
...
defs = Definitions(
    assets=[raw_fred, raw_ecb, raw_bundesbank, raw_ecbwatch, fx_macro_dbt_assets],
